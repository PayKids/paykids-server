...
public class ExpenseAllowanceController {
    ...
    @Operation(summary = "월 소비 전체 금액 조회", description = "주어진 달의 전체 소비 금액을 반환합니다. 소비 내역이 없으면 0을 리턴합니다.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "월, 일별 소비 금액 조회", description = "주어진 달의 일별 소비 금액을 반환합니다. 소비 내역이 없으면 amount가 0입니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공적으로 확인됨"),
            @ApiResponse(responseCode = "400", description = "잘못된 입력 값"),
            @ApiResponse(responseCode = "500", description = "서버 오류 발생")
    ...
    @Operation(summary = "월, 모든 카테고리 소비 조회", description = "주어진 달의 모든 카테고리 소비를 반환합니다. 소비 내역이 없으면 빈 배열을 반환합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공적으로 확인됨"),
            @ApiResponse(responseCode = "400", description = "잘못된 입력 값"),
            @ApiResponse(responseCode = "500", description = "서버 오류 발생")
    ...
    @Operation(summary = "월, 카테고리 중 최다 소비 조회", description = "주어진 달의 카테고리중 최다 소비를 반환합니다. 소비 내역이 없으면 빈 배열을 반환합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공적으로 확인됨"),
            @ApiResponse(responseCode = "400", description = "잘못된 입력 값"),
            @ApiResponse(responseCode = "500", description = "서버 오류 발생")
    ...
    public ApiResult<List<AllowanceChartCategoryDTO>> getMonthMostCategoryExpense(@RequestParam Integer year, @RequestParam Integer month, @RequestHeader("Authorization") String token) {
        return ApiResult.ok(expenseService.getMostCategoryExpense(year, month, token));
    }

    @Operation(summary = "일 소비 조회", description = "주어진 일의 소비 내역을 반환합니다. 소비 내역이 없으면 빈 배열을 반환합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공적으로 확인됨"),
            @ApiResponse(responseCode = "400", description = "잘못된 입력 값"),
            @ApiResponse(responseCode = "500", description = "서버 오류 발생")
    ...
    @Operation(summary = "월, 특정 카테고리 소비 조회", description = "주어진 달의 특정 카테고리 소비 내역을 반환합니다. 소비 내역이 없으면 빈 배열을 반환합니다.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "성공적으로 확인됨"),
            @ApiResponse(responseCode = "400", description = "잘못된 입력 값"),
            @ApiResponse(responseCode = "500", description = "서버 오류 발생")
